<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="学员ID" prop="stuInfoId">
        <el-input
          v-model="queryParams.stuInfoId"
          placeholder="请输入学员ID"
          clearable
          size="small"
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['jiaktb:achievement:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['jiaktb:achievement:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['jiaktb:achievement:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['jiaktb:achievement:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="achievementList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="成绩标识" align="center" prop="achievementId" />
      <el-table-column label="学员ID" align="center" prop="stuInfoId" />
      <el-table-column label="科目名称" align="center" prop="subName" />
      <el-table-column label="成绩" align="center" prop="cachievement" />
      <el-table-column label="考试时间" align="center" prop="testTime" width="180">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="学员ID" prop="stuInfoId">
          <el-input v-model="form.stuInfoId" placeholder="请输入学员ID" />
        </el-form-item>
        <el-form-item label="科目名称" prop="subName">
          <el-input v-model="form.subName" placeholder="请输入科目名称" />
        </el-form-item>
        <el-form-item label="成绩" prop="cachievement">
          <el-input v-model="form.cachievement" placeholder="请输入成绩" />
        </el-form-item>
        <el-form-item label="考试时间" prop="testTime">
          <el-date-picker clearable size="small"
...
<script>
import { listAchievement, getAchievement, delAchievement, addAchievement, updateAchievement, exportAchievement } from "@/api/jiaktb/achievement";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除成绩编号为"' + achievementIds + '"的数据项?', "警告", {
